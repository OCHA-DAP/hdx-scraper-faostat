...
class TestFaostat:
    ...
    def test_generate_dataset_and_showcase(self, configuration, downloader):
        datasets, showcases = generate_datasets_and_showcases(downloader, 'Food Security',
